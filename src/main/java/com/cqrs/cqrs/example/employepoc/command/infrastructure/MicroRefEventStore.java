package com.cqrs.cqrs.example.employepoc.command.infrastructure;


import com.cqrs.cqrs.example.employepoc.command.events.EventStoreRepository;
...
@Service
@EnableMongoRepositories(basePackages = "com.cqrs.cqrs.example.employepoc.command.events")
@ComponentScan({"com.hydatis.cqrsref.producer", "com.cqrs.cqrs.example.employepoc"})
