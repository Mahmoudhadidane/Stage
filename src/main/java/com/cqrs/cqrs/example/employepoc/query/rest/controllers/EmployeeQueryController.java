...
import com.cqrs.cqrs.example.employepoc.query.rest.response.FindAllEmpoyeesResponse;
import com.cqrs.cqrs.example.employepoc.query.rest.response.FindEmployeeByIdResponse;
...
public class EmployeeQueryController {
    ...
    public void consumeEmployeeEvents(EmployeeEvents employeeEvent) {
        ...
        switch (employeeEvent.getType()) {
            case "EmployeeCreated":
                employeeQueryService.save(employee);
                break;
    ...
    @GetMapping
    public List<com.cqrs.cqrs.example.employepoc.query.rest.dto.Employee> getAllEmployees() {
        return
                employeeQueryService.getAllEmployees();

    }

    @GetMapping("/{id}")
    public com.cqrs.cqrs.example.employepoc.query.rest.dto.Employee getEmployeeById(@PathVariable Long id) {
