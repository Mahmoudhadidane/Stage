package com.cqrs.cqrs.example.employepoc.config;
...
@SecurityScheme(name = "keycloak", type = SecuritySchemeType.HTTP,
        ...
        scheme = "bearer",
        flows = @OAuthFlows(clientCredentials = @OAuthFlow(authorizationUrl = "http://localhost:8082/auth/",
                tokenUrl = "http://localhost:8082/realms/timestamp-realm/protocol/openid-connect/token"
        )))
@EnableWebSecurity
